/**
  ******************************************************************************
  * @file    mt071x_eval_i2c_ee.c
  * @author  MIC Software Team
  * @version V1.0.0
  * @date    03/01/2018
  * @brief   This file provides a set of functions needed to manage the I2C AT24CXX 
  *          EEPROM memory mounted on MT071x_EVAL evaluation board.
  *         
  *              
  *          It implements a high level communication layer for read and write 
  *          from/to this memory. The needed MIC hardware resources (I2C and 
  *          GPIO) are defined in mt071x_eval.h file, and the initialization is 
  *          performed in sEE_LowLevel_Init() function declared in mt071x_eval.c 
  *          file.
...
/** @addtogroup MT071x_EVAL_I2C_EE
  * @brief      This file includes the I2C EEPROM driver of MT071x_EVAL boards.
  * @{
  */ 
...
#define I2C_EEPROM_CHIP_INDEX       1           //选择I2C EEPROM型号 Chip_List
...
/** @defgroup MT071x_EVAL_I2C_EE_Private_Functions
  * @{
  */ 
