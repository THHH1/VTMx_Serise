/**
  ...
  *          definitions and memory mapping for vtm071x devices.  
  *          
...
/**
 * @brief vtm071x Standard Peripheral Library version number V1.0.0
   */
#define __VTM071x_STDPERIPH_VERSION_MAIN   (0x01) /*!< [31:24] main version */
#define __VTM071x_STDPERIPH_VERSION_SUB1   (0x00) /*!< [23:16] sub1 version */
#define __VTM071x_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version */
#define __VTM071x_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */ 
#define __VTM071x_STDPERIPH_VERSION        ((__VTM071x_STDPERIPH_VERSION_MAIN << 24)\
                                         |(__VTM071x_STDPERIPH_VERSION_SUB1 << 16)\
                                         |(__VTM071x_STDPERIPH_VERSION_SUB2 << 8)\
                                         |(__VTM071x_STDPERIPH_VERSION_RC))
/**
  * @}
  */
...
/**
 * @brief vtm071x Interrupt Number Definition, according to the selected device 
...
typedef enum IRQn
{
	...
	/******  vtm071x specific Interrupt Numbers **********************************************************/
