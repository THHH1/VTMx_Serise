...
//  <i>Default: 32
#define RT_THREAD_PRIORITY_MAX  32	//设置系统最大优先级，可设置8到256，默认值32
// <o>OS tick per second
//  <i>Default: 1000   (1ms)
#define RT_TICK_PER_SECOND  1000	//默认100，一个节拍10ms，时钟节拍越快，系统的额外开销就越大
// <o>Alignment size for CPU architecture data access
//  <i>Default: 4
#define RT_ALIGN_SIZE   4			//字节对齐时设定对齐的字节个数，默认4
// <o>the max length of object name<2-16>
//  <i>Default: 8
#define RT_NAME_MAX    16			//设置对象名称的最大长度，默认为8个字符
// <c1>Using RT-Thread components initialization
//  <i>Using RT-Thread components initialization
#define RT_USING_COMPONENTS_INIT	//设置使用组件自动初始化功能，默认需要使用，开启该宏则可以使用自动初始化功能。
// </c>

#define RT_USING_USER_MAIN			//开启 RT_USING_USER_MAIN 宏，则打开 user_main 功能，默认需要开启，这样才能调用 RT-Thread 的启动代码；main 线程的栈大小可修改。
...
#define RT_USING_DEVICE				//开启该项则将加入 device 框架源码。
