/**
  ...
  *    
  ...
  ============================================================================== 
    ...
    [..] WWDG counter clock = PCLK / Prescaler.
    [..] WWDG timeout = (WWDG counter clock) * (counter value).

    [..] Min-max timeout value @84MHz (PCLK): ~781us / ~49.9ms.
...
{
    RCC_APBPeriphResetCmd(RCC_AHBCLKCTRL_WWDG, ENABLE);
    RCC_APBPeriphResetCmd(RCC_AHBCLKCTRL_WWDG, DISABLE);
}
...
/**
  ...
  *            @arg WWDG_Prescaler_1: WWDG counter clock = (PCLK1/4096/2)/1
  *            @arg WWDG_Prescaler_2: WWDG counter clock = (PCLK1/4096/2)/2
  *            @arg WWDG_Prescaler_4: WWDG counter clock = (PCLK1/4096/2)/4
  *            @arg WWDG_Prescaler_8: WWDG counter clock = (PCLK1/4096/2)/8
  * @retval None
  */
