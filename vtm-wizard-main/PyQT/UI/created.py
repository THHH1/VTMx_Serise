...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tableView.setGeometry(QtCore.QRect(20, 10, 746, 491))
        self.tableView.setObjectName("tableView")
        self.scrollArea = QtWidgets.QScrollArea(Form)
        self.scrollArea.setGeometry(QtCore.QRect(20, 10, 751, 491))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing)
